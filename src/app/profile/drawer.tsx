        ...
        <div className="mt-6 w-full px-4">
          <div className="flex flex-col border rounded-full border-[#fcf4f4] px-6 py-4">
            <div className="flex gap-2 items-center">
              <img
                src={`https://walrus-app-gofux.ondigitalocean.app/api/images/${achievement.imageUrl}`}
            ...
            items={challengeData.map((el, index) => (
              <div key={index}>
                <div className="flex size-64 relative mx-auto rounded-full justify-center my-4">
                  ...
                  {el.videoUrl && (
                    <video
                      src={`https://walrus-app-gofux.ondigitalocean.app/api/videos/download?fileId=${el.videoUrl}`}
