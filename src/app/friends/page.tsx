...
export default function FriendsPage() {
  ...
  const getFriends = async () => {
    ...
    const res = await fetch("https://getquest.tech:6443/api/users/friends", {
      method: "GET",
      headers,
    });
  ...
  const getRequests = async () => {
    ...
    const res = await fetch(
      "https://getquest.tech:6443/friends/requests/incoming",
      {
        method: "GET",
        headers,
      }
  ...
  const handleAccept = async (requestId: number) => {
    ...
    try {
      const res = await fetch(
        `https://getquest.tech:6443/friends/accept?requestId=${requestId}`,
        {
          method: "POST",
          headers,
        }
  ...
  const handleDecline = async (requestId: number) => {
    ...
    try {
      const res = await fetch(
        `https://getquest.tech:6443/friends/decline?requestId=${requestId}`,
        {
          method: "POST",
          headers,
        }
