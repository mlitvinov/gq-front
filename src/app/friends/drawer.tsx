...
export function SubmitQuestDrawer({
  ...
  React.useEffect(() => {
    const fetchAchievements = async () => {
      ...
      const response = await fetch(
        "https://walrus-app-gofux.ondigitalocean.app/api/achievements",
        {
          headers: {
      ...
      if (data.length > 0) {
        ...
        setImageUrl(
          `https://walrus-app-gofux.ondigitalocean.app/api/images/${data[0].imageUrl}`
        );
      }
    };
  ...
  const handleSubmit = async () => {
    ...
    const response = await fetch("https://walrus-app-gofux.ondigitalocean.app/api/challenges", {
      method: "POST",
      headers: {
        accept: "*/*",
        "Content-Type": "application/json",
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (selected) {
                    ...
                    setImageUrl(
                      `https://walrus-app-gofux.ondigitalocean.app/api/images/${selected.imageUrl}`
                    );
                  }
                }}
