...
export function ChallengeDrawer({
  ...
  const handleUpload = (selectedFile: File) => {
    ...
    const url = isPromo
      ? `https://walrus-app-gofux.ondigitalocean.app/api/promochallenges/${challengeId}/complete`
      : `https://walrus-app-gofux.ondigitalocean.app/api/challenges/${challengeId}/complete`;
  ...
  const handleAccept = async () => {
    ...
    try {
      const url = isPromo
        ? `https://walrus-app-gofux.ondigitalocean.app/api/promochallenges/${challengeId}/start`
        : `https://walrus-app-gofux.ondigitalocean.app/api/challenges/${challengeId}/accept`;
  ...
  const handleDecline = async () => {
    ...
    try {
      const response = await fetch(
        `https://walrus-app-gofux.ondigitalocean.app/api/challenges/${challengeId}/decline`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleApprove = async () => {
    ...
    try {
      const url = isPromo
        ? `https://walrus-app-gofux.ondigitalocean.app/api/promochallenges/${challengeId}/approve`
        : `https://walrus-app-gofux.ondigitalocean.app/api/challenges/${challengeId}/approve`;
  ...
  const handleDispute = async () => {
    ...
    try {
      const url = isPromo
        ? `https://walrus-app-gofux.ondigitalocean.app/api/promochallenges/${challengeId}/dispute`
        : `https://walrus-app-gofux.ondigitalocean.app/api/challenges/${challengeId}/dispute`;
        ...
        {fieldId && (
          <div className="flex justify-center mb-4">
            <figure className="rounded-full overflow-hidden w-24 h-24 bg-[#F6F6F6] flex items-center justify-center">
              ...
              >
                <source
                  src={`https://walrus-app-gofux.ondigitalocean.app/api/videos/download?fileId=${fieldId}`}
                  type="video/mp4"
                />
