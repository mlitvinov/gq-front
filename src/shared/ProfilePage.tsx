...
export default function ProfilePage({ params }: { params?: { id: number } }) {
    ...
    const fetchProfileData = async () => {
      try {
        ...
        const url = !isUserPage
          ? `https://walrus-app-gofux.ondigitalocean.app/api/users/profile/?id=${params?.id}`
          : "https://walrus-app-gofux.ondigitalocean.app/api/users/profile";
        ...
        setAchievementImages(
          data.achievementListDTO.map((achievement: Achievement) => ({
            ...
            imageUrl: `https://walrus-app-gofux.ondigitalocean.app/api/images/${achievement.imageUrl}`,
          }))
        );
      } catch (error) {
    ...
    const fetchVideoUrls = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `https://walrus-app-gofux.ondigitalocean.app/api/challenges/user/video-urls?userId=${userData.id}`,
          {
            method: "GET",
            headers,
          }
  ...
  const handleAchievementClick = async (id: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://walrus-app-gofux.ondigitalocean.app/api/challenges/achievement/${achievement.userAchievement}`,
        {
          method: "GET",
          headers,
        }
  ...
  const handleAddFriend = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://walrus-app-gofux.ondigitalocean.app/friends/request?receiverId=${userData.id}`,
        {
          method: "POST",
          headers,
        }
  ...
  const handleAcceptFriendRequest = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://walrus-app-gofux.ondigitalocean.app/friends/accept/${userData.id}`,
        {
          method: "POST",
          headers,
        }
        ...
        items={videoUrls.map((videoUrl, index) => (
          ...
          >
            <figure className="rounded-full overflow-hidden  size-64 bg-[#F6F6F6] flex items-center justify-center mr-6">
              ...
              >
                <source
                  src={`https://walrus-app-gofux.ondigitalocean.app/api/videos/download?fileId=${videoUrl}`}
                  type="video/mp4"
                />
